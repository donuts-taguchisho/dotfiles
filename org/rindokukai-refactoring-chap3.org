...
*** コード例
[[file:~/Documents/refactoring/01_mysterious_name.js][MysteriousName]]
...
*** コード例
[[file:~/Documents/refactoring/02_duplicated_code.js][Duplicated Code]]
...
*** コード例
[[file:~/Documents/refactoring/03_long_function.js][Long Function]]
...
*** コード例
[[file:~/Documents/refactoring/04_long_parameter_list.js][Long Parameter List]]
...
*** コード例
[[file:~/Documents/refactoring/05_global_data.js][Global Data]]
...
*** コード例
[[file:~/Documents/refactoring/06_mutable_data.js][Mutable Data]]
...
*** コード例
[[file:~/Documents/refactoring/07_divergent_change.js][Divergent Change]]
...
*** コード例
[[file:~/Documents/refactoring/08_shotgun_surgery.js][Shotgun Surgery]]
...
*** コード例
[[file:~/Documents/refactoring/09_feature_envy.js][Feature Envy]]
...
*** コード例
[[file:~/Documents/refactoring/10_data_clumps.js][Data Clumps]]
...
*** コード例
[[file:~/Documents/refactoring/11_primitive_obsession.js][Primitive Obsession]]
...
*** コード例
[[file:~/Documents/refactoring/12_repeated_switches.js][Repeated Switches]]
...
*** コード例
[[file:~/Documents/refactoring/13_loops.js][Loops]]
...
*** コード例
[[file:~/Documents/refactoring/14_lazy_element.js][Lazy Element]]
...
*** コード例
[[file:~/Documents/refactoring/15_speculative_Generality.js][Speculative Generality]]
...
*** コード例
[[file:~/Documents/refactoring/16_temporary_field.js][Temporary Field]]
...
*** コード例
[[file:~/Documents/refactoring/17_message_chains.js][Message Chains]]
...
*** コード例
[[file:~/Documents/refactoring/18_middle_man.js][Middle Man]]
...
*** コード例
[[file:~/Documents/refactoring/19_insider_trading.js][Insider Trading]]
...
*** コード例
[[file:~/Documents/refactoring/20_large_class.js][Large Class]]
...
*** コード例
[[file:~/Documents/refactoring/21_alternative_classes_with_different_interfaces.js][Alternative Classes with Different Interfaces]]
...
*** コード例
[[file:~/Documents/refactoring/22_data_class.js][Data Class]]
...
*** コード例
[[file:~/Documents/refactoring/23_refused_bequest.js][Refused Bequest]]
...
*** コード例
[[file:~/Documents/refactoring/24_comments.js][Comments]]
